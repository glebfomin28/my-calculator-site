...
export const Calculator = () => {
  const { calcValue, expressionValue, inputRef, calculate, handleChange, handleFocus } = useCalculatorControl();
  ...
  return (
    <div className={cls.calculator}>
      <div className={cls.calculator_scoreboard}>
        ...
        <Input ref={inputRef} value={calcValue} autoFocus onClick={handleFocus} onChange={handleChange} />
      </div>
